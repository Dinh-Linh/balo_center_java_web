...
<head>
    ...
    <link href="${pageContext.request.contextPath}/eshopper/lib/owlcarousel/assets/owl.carousel.min.css"
          rel="stylesheet">
...
<div class="container-fluid bg-secondary text-dark mt-5 pt-5">
    <div class="row px-xl-5 pt-5">
        <div class="col-lg-4 col-md-12 mb-5 pr-3 pr-xl-5">
            ...
            <p>Welcome to our online store. We offer high-quality products at affordable prices. Shop with confidence
                and enjoy our excellent customer service.</p>
        ...
        <div class="col-lg-8 col-md-12">
            <div class="row">
                ...
                <div class="col-md-4 mb-5">
                    ...
                    <div class="d-flex flex-column justify-content-start">
                        <a class="text-dark mb-2" href="${pageContext.request.contextPath}/view/auth/login"><i
                                class="fa fa-angle-right mr-2"></i>Sign In</a>
                        <a class="text-dark mb-2" href="${pageContext.request.contextPath}/view/auth/register"><i
                                class="fa fa-angle-right mr-2"></i>Sign Up</a>
