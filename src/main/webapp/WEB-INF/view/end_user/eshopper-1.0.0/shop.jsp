            ...
            <div class="col-lg-9 col-md-12">
                <div class="row pb-3">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card productSell-item border-0 mb-4">
                            <div class="card-header productSell-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/productSell-6.jpg" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card productSell-item border-0 mb-4">
                            <div class="card-header productSell-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/productSell-7.jpg" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                <div class="d-flex justify-content-center">
                    ...
                    <div class="col-lg-4 col-md-6 col-sm-12 pb-1">
                        <div class="card productSell-item border-0 mb-4">
                            <div class="card-header productSell-img position-relative overflow-hidden bg-transparent border p-0">
                                <img class="img-fluid w-100" src="img/productSell-8.jpg" alt="">
                            </div>
                            <div class="card-body border-left border-right text-center p-0 pt-4 pb-3">
                                <h6 class="text-truncate mb-3">Colorful Stylish Shirt</h6>
                                <div class="d-flex justify-content-center">
